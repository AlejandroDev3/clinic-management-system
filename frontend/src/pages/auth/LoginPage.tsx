    ...
    return(
              <section className="w-screen h-screen flex justify-center items-center bg-gradient-to-br from-blue-100 to-indigo-200">
                <div className="w-230 bg-blue-100 inset-0 h-120 relative fit flex justify-center items-center overflow-hidden rounded-md  shadow-xl backdrop-blur-[2px]">
                  <div className="w-230 bg-blue-100 h-120 relative fit flex justify-center items-center overflow-hidden rounded-md  hover:bg-slate-100 shadow-xl">
                  ...
                  <form action="login"  className="grid grid-cols-2  items-center h-full">
                    ...
                    <div className="grid grid-cols-1  items-center">
                      ...
                      >
                        Health<span className="text-yellow-500">Match</span>
                      </Label>
                          <Button
                            className="
                              px-6
                      ...
                      >
                        Si no tienes cuenta <Button type="button" onClick={() => navigate("/register")} className="bg-0 p-0 text-base hover:bg-0 cursor-pointer text-white transition-all hover:scale-102 hover:text-yellow-300 text-shadow-lg">registrate</Button>
                      </Label>
                    </div>
                  </div>
                  </form>
